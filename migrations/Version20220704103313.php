 ...
 */
final class Version20220704103313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE like_comment (comment_id INT NOT NULL, like_by_id INT NOT NULL, PRIMARY KEY(comment_id, like_by_id))');
        $this->addSql('CREATE INDEX IDX_C7F9184FF8697D13 ON like_comment (comment_id)');
        $this->addSql('CREATE INDEX IDX_C7F9184F1D8309E3 ON like_comment (like_by_id)');
        ...
        $this->addSql('ALTER TABLE like_comment ADD CONSTRAINT FK_C7F9184FF8697D13 FOREIGN KEY (comment_id) REFERENCES comment (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE like_comment ADD CONSTRAINT FK_C7F9184F1D8309E3 FOREIGN KEY (like_by_id) REFERENCES "user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE like_comment DROP CONSTRAINT FK_C7F9184FF8697D13');
        ...
        $this->addSql('ALTER TABLE like_comment DROP CONSTRAINT FK_C7F9184F1D8309E3');
